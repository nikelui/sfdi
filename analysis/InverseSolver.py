...
from sfdi.commons import models  # fluence models
SDA = models.phi_diff
dP1 = models.phi_dP1
...
def min_fun(x0, mua_meas, mus_meas, z, fx, model=SDA):
...
"""
    dz = z[1] - z[0]  # discrete depth step
...
FX = FX[:,np.newaxis]  # reshape, dimensions: (N x 1)
...
for _d, d in d_real:  # loop over thickness
