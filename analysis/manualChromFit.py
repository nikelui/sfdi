...
#    - for plotting mua (skin): skiprows=125, nrows=1  #
...
if False:  # mus    
    ...
    axb[0].bar(x+0.25, par_mat[0,2,:], width=0.5)
    ...
    axb[1].bar(x+0.25, par_mat[1,2,:], width=0.5)
    # axb[1].set_ylabel('%')
