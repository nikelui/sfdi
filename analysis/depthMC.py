...
def depthMC(mua, mus, fx):
    ...
    # Initialize return variable 'depths' of dimensions [cdflevel, fxs]
    depths = np.zeros((len(cdflevels),len(fx)), dtype=float)
