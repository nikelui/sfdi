...
Diffuse reflectance model using pre-computed white Monte Carlo simulation
...
from sfdi.processing import models
...
def reflecMCSFD(mua,mus,n,freqs,MC={}):
    ...
    if len(MC) == 0: # Trying to implement persistence
        ...
        temp = loadmat('{}/{}'.format(path, mc_sim_type))  # if the Monte Carlo has not been loaded
